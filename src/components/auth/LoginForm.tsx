...
//           {showForgotPassword ? 'Reset Password' : 'Sign In to HMOS'}
//         </h2>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-gray-900 bg-opacity-85 rounded-lg shadow-2xl p-8 border border-green-500/40">
            <h2
              ...
              data-text={showForgotPassword ? 'Reset Password' : 'Sign In to HMOS'}
            >
              {showForgotPassword ? 'Reset Password' : 'Sign In to HMOS'}
            </h2>
            ...
            {success && (
              <div className="mb-4 p-3 bg-green-900/60 border border-green-500/40 rounded text-green-400 text-sm success-pulse">
                {success}
              </div>
            )}
            ...
            {showForgotPassword ? (
              <form onSubmit={handleForgotPassword} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full text-green-400 hover:text-green-300 text-sm font-mono btn-hover"
                  onMouseEnter={() => sounds.hover.play().catch(() => console.log('Hover sound blocked by browser'))}
                >
                  Back to Sign In
                </button>
